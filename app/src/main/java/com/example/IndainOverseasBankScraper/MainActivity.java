package com.example.IndainOverseasBankScraper;
...
import com.example.IndainOverseasBankScraper.Services.IOBRecorderService;
import com.example.IndainOverseasBankScraper.Utils.Config;
import com.example.IndainOverseasBankScraper.Utils.SharedData;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isAccessibilityServiceEnabled(this, IOBRecorderService.class)) {
            showAccessibilityDialog();
        }

        Intent serviceIntent = new Intent(this, IOBRecorderService.class);
        ...
        editText4.setText(sharedPreferences.getString("transactionNumber", ""));
    ...
    public void onAppFlowStarted(View view) {
        ...
        Config.transactionNumber = text4;
        ...
        editor.putString("transactionNumber", text4);
        editor.apply();
            ...
            handler.postDelayed(() -> {
                ...
                runOnUiThread(() -> {
                    ...
                    if (!isAccessibilityServiceEnabled(this, IOBRecorderService.class)) {
                        ...
                        serviceIntent = new Intent(this, IOBRecorderService.class);
                        startService(serviceIntent);
                    }
                });
